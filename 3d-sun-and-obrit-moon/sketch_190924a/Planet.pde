 class Planet{
  ...
  Planet(float r, float d, float o){
    ...
    radius = r;
    distance = d;
    v.mult(distance);//scare it by distance 
    orbitspeed = o;
    angle = random(TWO_PI);
  }
...
//   float o = random(0.02, 0.07);
 ...
 void show(){
   ...
   rotate( angle, p.x, p.y, p.z);//rotate should set before translate
//   line(0, 0, 0, v.x, v.y, v.z );//show the vector of planets rotating 
